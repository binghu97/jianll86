...
public class IconComboBoxDemo extends JFrame{
	...
	JComboBox iconComboBox=null;  //定制的选择下拉框
      ...
      //定义Object二维数组,用于初始化下拉框,参数依次为图标,显示文本,提示文本
   	  Object[][] obj={
   	  	{new ImageIcon("D:/工作文件/2018年工作/2018年工作/java/实例1 产生自己的控件/1.gif"),"旅游","提供旅游的最新信息"},
   	  	{new ImageIcon("D:/工作文件/2018年工作/2018年工作/java/实例1 产生自己的控件/2.gif"),"音乐","提供最新的音乐资讯，古典的、流行的..."},
   	  	{new ImageIcon("D:/工作文件/2018年工作/2018年工作/java/实例1 产生自己的控件/3.gif"),"聊天","与朋友聊天"},
   	  	{new ImageIcon("D:/工作文件/2018年工作/2018年工作/java/实例1 产生自己的控件/4.gif"),"影视","影视娱乐"},
   	  	{new ImageIcon("D:/工作文件/2018年工作/2018年工作/java/实例1 产生自己的控件/5.gif"),"家居","家居世界"},
   	  };
