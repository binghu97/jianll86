...
sleep 8s
rm /opt/log/* -f
sed  -e 's/[ ]*$//g' /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/ipjavajianyan.txt
sed -i 's/\r$//g'    /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/ipjavajianyan.txt
...
iplist=`cat /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/ipjavajianyan.txt`
...
sleep 5s
cp /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/ipjavajianyan.txt /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest
cd  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest
hangshu=`cat /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/ipjavajianyan.txt  |wc -l`

if [ $hangshu -gt 0 ] && [ $hangshu -le 100 ];then
split -l 3  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa
elif [ $hangshu -gt 100 ] && [ $hangshu -le 800 ];then
split -l 8  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa

elif [ $hangshu -gt 800 ] && [ $hangshu -le 1500 ];then

split -l 15  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa
elif [ $hangshu -gt 1500 ] && [ $hangshu -le 2000 ];then
split -l 20  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa

else
split -l 30  /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa
fi


#split -l 70 /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/ipjavajianyan.txt -a 4 xa
sleep 12s
ln=`ls -l /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/xa*|wc -l`
ipqiegelist=`ls -l /opt/tomcatidc/webapps/jcIDCpiliangcaozuo/upload/qiegeipjianyantest/xa*|awk '{print $9}'`
sleep 8s
...
do
#ipqielistttt=`cat $num`
nohup /opt/tomcatidc/zhixingdanjianyan10s.sh $num  >> /opt/tomcatidc/ipjavalogzong.log &
done
sleep 115s
